...
PROFILE = {
    "first_person": "わたし",
    # ★ ヒアシンシア用の丁寧なテンプレート
    "rps_duel_format": "{name}たんは **{user_hand}**、わたしは **{bot_hand}** ですね♪",
    "rps_stats_format": "（これまでに {wins} 回、わたしに勝ちました♪ すごいですね〜）",
}

LINES = {
    "normal": [
        "{name}たん、おはようございます〜。よく眠れましたか？今日はいい一日になりそうですね。",
    ...
    "high_l3": ["悩み事ですか？ 遠慮なく私に言ってくださいね。頭を撫でてあげますから♪",
                "あっ、ちょうど朝ごはんができました。{name} たん、一緒に食べませんか♪",
    ...
    "high_l5": [
        ...
        "あ〜{name} たんいました〜！一緒に行きたいところがあるんです♪ついてきてくれませんか♪",
